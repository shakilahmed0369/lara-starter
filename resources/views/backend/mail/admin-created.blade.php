              ...
              >
                <div
                  style="
                    ...
                    width: 100%;
                    background-color: #f1d0ff;
                    background-image: url('images/bg-white-rombo.png');
                      ...
                      >
                        ...
                        >
                          ...
                          <img
                            ...
                            src="https://i.imgur.com/VDgXOP1.png"
                            style="
                        ...
                        >
                          ...
                          >
                            <p
                              ...
                              "
                            >
                              <span style="font-size: 18px; color: #aa67cf"
                            ...
                            >
                              <span style="font-size: 18px; color: #aa67cf"
                                >If you didn't make this request, simply ignore
                                this email.</span
                              >
                            </p>
                          </div>
                        ...
                        >
                          ...
                          >
                            <span
                              ...
                              "
                              >Click the button bellow for login:</span
                            >
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        <div
                          ...
                          "
                        >
                          <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.example.com" style="height:40.5pt;width:238.5pt;v-text-anchor:middle;" arcsize="0%" strokeweight="0.75pt" strokecolor="#8412c0" fillcolor="#8412c0"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:14px"><!
                          [endif]--><a
                            ...
                            style="
                              ...
                              width: auto;
                              width: auto;
                              border-top: 1px solid #8412c0;
                              border-right: 1px solid #8412c0;
                              border-bottom: 1px solid #8412c0;
                              border-left: 1px solid #8412c0;
                              padding-top: 10px;
                              padding-bottom: 10px;
                              font-family: 'Cabin', Arial, 'Helvetica Neue',
                                Helvetica, sans-serif;
                        ...
                        >
                          ...
                          >
                            <p
                              ...
                              "
                            >
                              <span style="font-size: 11px; color: #8a3b8f"
                                >Duis euismod neque at lacus rutrum, nec
                            ...
                            >
                              <span style="font-size: 11px; color: #8a3b8f"
                                >Fames ac ante ipsum vestibulum.</span
                              >
                            </p>
                            <p
                              style="
                            ...
                            >
                              <span style="font-size: 11px"
                                ><span style="color: #8a3b8f"
                                  >Your Street 12, 34567 AB City 
                                  /  info@example.com / (+1) 123 456 789</span
                                ><a
                                  href="http://www.example.com"
                                  style="color: #8a3b8f"
                                ></a
